...
[![npm version](https://badge.fury.io/js/%40ansvar/australian-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/australian-law-mcp)
...
| `get_australian_law_implementations` | Find Australian laws implementing EU act |
...
- All statute text is ingested from official Australian government sources
...
All content is sourced from authoritative Australian legal databases:

- **[Federal Register of Legislation](https://www.legislation.gov.au)** -- Official Australian government legal database
...
>
> Statute text is sourced from official Australian government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Australian-law-mcp
...
```bibtex
@software{australian_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Australian Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Australian-law-mcp},
  note = {Australian legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Australian Government (CC BY 4.0)
